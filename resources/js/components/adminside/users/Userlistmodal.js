...
const UserModal = ({ onClose, onSubmit, isEdit, initialData }) => {
  ...
  useEffect(() => {
    if (isEdit && initialData) {
      setFormData({
        ...
        password: "",
        role_id: initialData.role_id?.toString() || "1",
        profile_img: null,
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "usermodal" },
      React.createElement("h2", null, isEdit ? "Edit User" : "Add New User"),
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("option", { value: "", disabled: true }, "Select Gender"),
            React.createElement("option", { value: "Male" }, "Male"),
            React.createElement("option", { value: "Female" }, "Female"),
            React.createElement("option", { value: "Other" }, "Other")
          ),
          errors.gender && React.createElement("span", { className: "error" }, errors.gender)
        ),
        React.createElement(
          "div",
          { className: "form-group" },
          ...
          React.createElement(
            ...
            React.createElement("option", { value: "2" }, "Employer"),
            React.createElement("option", { value: "3" }, "Worker")
          ),
