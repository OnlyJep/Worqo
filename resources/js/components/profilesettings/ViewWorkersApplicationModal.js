...
const ViewWorkersApplicationModal = ({ jobPostId, jobTitle, onClose }) => {
  ...
  return (
    <div className="view-workers-application-modal-overlay">
      <div className="view-workers-application-modal">
        <div className="modal-header">
          <h2>View Applications - {jobTitle}</h2>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <h3>No Applications for Interview</h3>
            <p>No applications are currently scheduled for interview.</p>
          </div>
        ) : (
          <>
...
export default ViewWorkersApplicationModal;
