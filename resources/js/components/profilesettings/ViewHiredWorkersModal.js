...
import '../../../sass/components/profilesettings/viewhiredworkersmodal.scss';

const ViewHiredWorkersModal = ({ jobPostId, jobTitle, onClose }) => {
  ...
  const filteredApplications = applications.filter(app => app.status === 'accepted');
  ...
  return (
    <div className="view-hired-workers-modal-overlay">
      <div className="view-hired-workers-modal">
        <div className="modal-header">
          <h2>Hired Workers - {jobTitle}</h2>
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p>No workers have been hired for this job yet.</p>
          </div>
        ) : (
          <>
...
export default ViewHiredWorkersModal;
